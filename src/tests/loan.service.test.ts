...
describe("Loan Service", () => {
  ...
  describe("createLoan", () => {
    ...
    it("should calculate installment amount correctly", async () => {
      const mockLoan = createMockLoan({ installmentAmount: 500 });
      prismaMock.loan.create.mockResolvedValue(mockLoan);
      ...
      expect(callArgs.data.installmentAmount).toBe(500);
    });
...
describe("Loan Domain Logic", () => {
  describe("canApplyPayment", () => {
    ...
    it("should return true for CANCELED loans", () => {
      expect(canApplyPayment(LoanStatus.CANCELED)).toBe(true);
    });
