...
export default function NotaPagarePage() {
  ...
  return (
    <div>
      <div className="breadcrumb">
        ...
        <span className="breadcrumb-current">Nota de Pagare</span>
      </div>

      <div className="page-header">
        <div>
          <h1 className="page-title">Nota de Pagare</h1>
          <p className="page-subtitle">Busca un cliente y selecciona un prestamo para generar la nota de pagare</p>
        </div>
      </div>
      ...
      {selectedLoan && (
        <div className="card">
          <div className="step-header"><span className="step-number">3</span><h2 className="step-title">Generar Nota de Pagare</h2></div>
          ...
          <div className="action-buttons">
            <ReportButton type="nota-pagare" entityId={selectedLoan.id} label="Ver Nota de Pagare" variant="primary" size="lg" mode="preview" />
            <ReportButton type="nota-pagare" entityId={selectedLoan.id} label="Descargar PDF" variant="outline" size="lg" mode="download" />
          </div>
        </div>
      )}
