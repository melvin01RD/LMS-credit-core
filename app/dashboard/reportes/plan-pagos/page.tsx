  ...
  return (
    <div>
      <div className="breadcrumb">
        ...
        <span className="breadcrumb-current">Plan de Pagos</span>
      </div>

      <div className="page-header">
        <div>
          <h1 className="page-title">Plan de Pagos</h1>
          <p className="page-subtitle">Busca un cliente y selecciona un prestamo para generar la tabla de amortizacion</p>
        </div>
      </div>
      ...
      {selectedLoan && (
        <div className="card">
          <div className="step-header"><span className="step-number">3</span><h2 className="step-title">Generar Plan de Pagos</h2></div>
          ...
          <div className="action-buttons">
            <ReportButton type="plan-pagos" entityId={selectedLoan.id} label="Ver Plan de Pagos" variant="primary" size="lg" mode="preview" />
            <ReportButton type="plan-pagos" entityId={selectedLoan.id} label="Descargar PDF" variant="outline" size="lg" mode="download" />
          </div>
        </div>
      )}
